...
// Function to delete data after a set interval
function deleteDataAfterInterval() {
  // console.log('Deleting data...');
  myData = {}; // Clear the data variable
}

////////////////get recently sent request/////////////////////////
app.get('/getRequest',async(req,res)=>{
 
    await res.json({ request: request });
 
 

  const interval = 1000*60*30; // 5 seconds

  // Schedule the function to run after the interval
  setTimeout(deleteDataAfterInterval, interval);
  request='';
